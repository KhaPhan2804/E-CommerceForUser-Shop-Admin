...
type PendingRouteProp = RouteProp<ParamList, 'Cancel'>;
...
export default function Canceling() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Đơn hàng bị hủy</Text>
      </View>
      ...
      {isLoading ? (
        ...
        <ScrollView contentContainerStyle={styles.cardList}>
          {orders.length === 0 ? (
            <Text style={styles.noOrdersText}>-- Không có đơn hàng nào đã hủy --</Text>
          ) : (
