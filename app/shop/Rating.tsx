...
type PendingRouteProp = RouteProp<ParamList, 'RatingTotal'>;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Đơn hàng đang chờ đánh giá</Text>
      </View>
      ...
      {isLoading ? (
        ...
        <ScrollView contentContainerStyle={styles.cardList}>
          {orders.length === 0 ? (
            <Text style={styles.noOrdersText}>-- Không có đơn hàng nào đang chờ đánh giá --</Text>
          ) : (
