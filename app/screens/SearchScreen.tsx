...
type navigationProp = NativeStackNavigationProp<ParamList, 'SearchProduct'>;
...
export default function SearchScreen() {
  ...
  if (searchTerm.trim()) {
    storeSearchData();  
    navigation.navigate('SearchProduct', { searchTerm: searchTerm });
  }
  };
  ...
  const handleSearchTermClick = (term: string) => {
    ...
    if (searchValue.trim()) {
      storeSearchData();  
      navigation.navigate('SearchProduct', { searchTerm: searchValue  });
    }
  };
